...
const FEATURES = [
  { icon: '⚡', title: 'Real-Time Sync', desc: 'Yjs CRDTs + WebRTC keep every keystroke synced across peers with zero conflict.' },
  { icon: '✦', title: 'AI Assistant', desc: 'Explain, debug, review, and analyze architecture with Gemini-powered insights.' },
  { icon: '▶', title: 'Collaborative Terminal', desc: 'Run code and share output live. Every collaborator sees the same terminal.' },
  { icon: '⬜', title: 'Version History', desc: 'Snapshot any file state. Visualize diffs. Restore with one click.' },
  { icon: '👁', title: 'Live Presence', desc: 'See who\'s editing in real time — cursors, selections, and activity metrics.' },
  { icon: '⌨', title: 'Multi-Language', desc: 'JavaScript, Python, TypeScript, Java, C++, Go, Rust, and more.' },
]
...
export default function Landing() {
  ...
  const handleJoin = () => {
    ...
    if (!id) { setJoinError('Enter a room ID or paste a link'); return }
    ...
    <div className="landing">
      ...
      <section className="landing-hero">
        ...
        <p className="hero-sub">
          ...
          AI-powered code analysis, and a shared terminal — all in your browser.
        </p>
        ...
        {joinError && (
          <div style={{ color: 'var(--red)', fontSize: 13, marginTop: 8 }}>{joinError}</div>
        )}
      </section>
