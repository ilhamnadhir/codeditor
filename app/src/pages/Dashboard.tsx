    ...
    return (<div className="dashboard">
      ...
      <div className="dashboard-body">
        ...
        <div style={{
          ...
          <input className="input-field" style={{ flex: 1, maxWidth: 360 }} placeholder="New workspace name…" value={newName} onChange={e => setNewName(e.target.value)} onKeyDown={e => e.key === 'Enter' && handleCreate()} id="new-workspace-input"/>
          <button className="btn btn-primary" onClick={handleCreate} disabled={creating} id="create-workspace-btn">
        ...
        {rooms.length > 0 && (<>
            ...
            <div className="workspace-grid">
              {rooms.map(room => (<div key={room.id} className="workspace-card" onClick={() => navigate(`/room/${room.id}`)} id={`workspace-${room.id}`}>
                  ...
                  <div className="workspace-card-footer">
                    ...
                    <button className="btn btn-ghost btn-sm" onClick={e => { e.stopPropagation(); handleShare(room.id); }}>
        ...
        {recentRooms.length > 0 && (<>
            ...
            <div className="workspace-grid">
              {recentRooms.map(r => (<div key={r.id} className="workspace-card" onClick={() => navigate(`/room/${r.id}`)}>
                  ...
                  <div className="workspace-card-footer">
                    ...
                    <button className="btn btn-ghost btn-sm" onClick={e => { e.stopPropagation(); handleShare(r.id); }}>
        ...
        {rooms.length === 0 && recentRooms.length === 0 && (<div style={{ textAlign: 'center', padding: '60px 0', color: 'var(--text-muted)' }}>
